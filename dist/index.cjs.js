...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("image", { width: "32", height: "32", href: "/images/kawaii/spinner/logo.png" })));
};
...
var Icon$B = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 80 80" }, props),
        React__default['default'].createElement("g", { clipPath: "url(#clip0)" },
            ...
            React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M57.157 45.058L23.1564 35.9476C21.4493 35.4902 19.6947 36.5032 19.2373 38.2103L13.5432 59.4607C13.0858 61.1678 14.0989 62.9225 15.806 63.3799L49.8066 72.4903C51.5137 72.9477 53.2683 71.9347 53.7257 70.2276L59.4198 48.9772C59.8772 47.2701 58.8641 45.5154 57.157 45.058ZM23.9847 32.8566C20.5705 31.9418 17.0611 33.9679 16.1463 37.3821L10.4523 58.6325C9.53745 62.0467 11.5636 65.556 14.9778 66.4709L48.9783 75.5813C52.3925 76.4961 55.9019 74.47 56.8167 71.0558L62.5107 49.8054C63.4256 46.3912 61.3994 42.8819 57.9852 41.9671L23.9847 32.8566Z", fill: "#ff6633" }),
            React__default['default'].createElement("path", { d: "M35.9629 36.0654L46.0085 38.7571L37.0016 72.3714L26.956 69.6797L35.9629 36.0654Z", fill: "#000080" }),
            React__default['default'].createElement("path", { d: "M11.8535 53.0029L14.5452 42.9573L61.111 55.4346L58.4193 65.4802L11.8535 53.0029Z", fill: "#000080" }),
            React__default['default'].createElement("g", { style: { mixBlendMode: "multiply" } },
                React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M30.0918 57.9047L40.1732 60.606L39.7591 62.1515L29.6777 59.4502L30.0918 57.9047ZM42.8724 50.5325L32.791 47.8312L33.2051 46.2857L43.2865 48.987L42.8724 50.5325Z", fill: "#000080" })),
            ...
            React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M58.9569 16.7985L15.6834 28.3936C14.8299 28.6223 14.3233 29.4996 14.552 30.3531L15.6908 34.6032C15.9196 35.4568 16.7969 35.9633 17.6504 35.7346L60.9239 24.1395C61.7775 23.9108 62.284 23.0335 62.0553 22.1799L60.9165 17.9298C60.6878 17.0763 59.8104 16.5698 58.9569 16.7985ZM14.8552 25.3026C12.2946 25.9887 10.775 28.6207 11.4611 31.1814L12.5999 35.4314C13.286 37.9921 15.918 39.5117 18.4787 38.8256L61.7521 27.2305C64.3128 26.5443 65.8324 23.9123 65.1462 21.3517L64.0074 17.1016C63.3213 14.541 60.6893 13.0214 58.1287 13.7075L14.8552 25.3026Z", fill: "#ff6633" }),
            React__default['default'].createElement("path", { d: "M31.4707 20.8506L41.5163 18.1589L45.1398 31.6818L35.0942 34.3735L31.4707 20.8506Z", fill: "#000080" }),
            React__default['default'].createElement("g", { style: { mixBlendMode: "multiply" } },
                React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M31.9671 22.5998L41.9672 19.7998L41.5673 17.9998L31.3975 20.8215L31.9671 22.5998Z", fill: "#000080" }))),
        React__default['default'].createElement("defs", null,
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/kawaii/spinner/spinner.png" })));
};
...
var Icon$I = function (props) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("image", { width: "28", height: "28", href: theme.isDark ? '/images/kawaii/icons/Farms_dark.png' : "/images/kawaii/icons/Farms.png" })));
};

var Icon$J = function (props) {
    var theme = useTheme();
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("image", { width: "28", height: "28", href: theme.isDark ? '/images/kawaii/icons/Refferals_dark.png' : "/images/kawaii/icons/Refferals.png" })));
};
...
var Icon$M = function (props) {
    var theme = useTheme();
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("image", { width: "28", height: "28", href: theme.isDark ? '/images/kawaii/icons/Home_dark.png' : "/images/kawaii/icons/Home.png" })));
};
...
var Icon$O = function (props) {
    var theme = useTheme();
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("image", { width: "28", height: "28", href: theme.isDark ? '/images/kawaii/icons/Info_dark.png' : "/images/kawaii/icons/Info.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 205 78" }, props),
        React__default['default'].createElement("image", { width: "205", height: "78", href: isDark ? '/images/kawaii/logo/LogoTextNewDark.png' : '/images/kawaii/logo/LogoTextNewWhite.png' })));
};
...
var Icon$R = function (props) {
    var theme = useTheme();
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("image", { width: "28", height: "28", href: theme.isDark ? '/images/kawaii/icons/More_dark.png' : "/images/kawaii/icons/More.png" })));
};
...
var Icon$T = function (props) {
    var theme = useTheme();
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("image", { width: "28", height: "28", href: theme.isDark ? '/images/kawaii/icons/Pools_dark.png' : "/images/kawaii/icons/Pools.png" })));
};
...
var Icon$V = function (props) {
    var theme = useTheme();
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: theme.isDark ? '/images/kawaii/icons/Telegram_dark.png' : "/images/kawaii/icons/Telegram.png" })));
};
...
var Icon$X = function (props) {
    var theme = useTheme();
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("image", { width: "28", height: "28", href: theme.isDark  ? '/images/kawaii/icons/Trade_dark.png' : "/images/kawaii/icons/Trade.png" })));
};

var Icon$Y = function (props) {
    var theme = useTheme();
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: theme.isDark ? '/images/kawaii/icons/Twitter_dark.png' : "/images/kawaii/icons/Twitter.png" })));
};
...
var Icon$_ = function (props) {
    var theme = useTheme();
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("image", { width: "28", height: "28", href: theme.isDark ? '/images/kawaii/icons/Audit_dark.png' : "/images/kawaii/icons/Audit.png" })));
};

var Icon$20 = function (props) {
    var theme = useTheme();
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: theme.isDark ? '/images/kawaii/icons/Discord_dark.png' : "/images/kawaii/icons/Discord.png" })));
};
...
var socials = [
    ...
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/kawaiiswap",
    },
];
var MENU_HEIGHT = 76;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#000066", textDisabled: "#BDC2C4", textSubtle: "#204060", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#b3b3ff", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#ff6633", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#312f37", gradients: {
